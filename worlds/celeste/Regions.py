...
from .Locations import CelesteLocation, locForsakenCity_table, locOldSite_table
...
def create_regions(world: MultiWorld, player: int):
    ...
    if last_level > 1:
        ...
        forsaken_city_to_old_site = Entrance(player, 'Old Site', regForsakenCity)
        forsaken_city_to_old_site.connect(regOldSite)
        regForsakenCity.exits.append(forsaken_city_to_old_site)
